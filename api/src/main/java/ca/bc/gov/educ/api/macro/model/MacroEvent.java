...
/**
 * The type Macro event.
 */
@AllArgsConstructor
@NoArgsConstructor
@Builder
@Entity
@Table(name = "MACRO_EVENT")
@Data
@DynamicUpdate
public class MacroEvent {
  ...
  /**
   * The type Macro event builder.
   */
  public static class MacroEventBuilder {
    /**
     * The Event payload bytes.
     */
     ...
     *
     * @param eventPayload the event payload
     * @return the macro event builder
     */
    public MacroEventBuilder eventPayload(final String eventPayload) {
