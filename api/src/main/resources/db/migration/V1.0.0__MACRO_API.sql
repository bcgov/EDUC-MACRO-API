...
LOB (PAYLOAD) STORE AS PAYLOAD (TABLESPACE API_PEN_BLOB_DATA);

CREATE INDEX MACRO_SAGA_STATUS_IDX ON MACRO_SAGA (STATUS);
CREATE INDEX MACRO_SAGA_MACRO_ID_IDX ON MACRO_SAGA (MACRO_ID);

ALTER INDEX API_MACROS.MACRO_SAGA_PK REBUILD TABLESPACE API_PEN_IDX;
ALTER INDEX API_MACROS.MACRO_SAGA_STATUS_IDX REBUILD TABLESPACE API_PEN_IDX;
ALTER INDEX API_MACROS.MACRO_SAGA_MACRO_ID_IDX REBUILD TABLESPACE API_PEN_IDX;
...
LOB (SAGA_EVENT_RESPONSE) STORE AS SAGA_EVENT_RESPONSE (TABLESPACE API_PEN_BLOB_DATA);
...
ALTER INDEX API_MACROS.MACRO_SAGA_EVENT_STATES_PK REBUILD TABLESPACE API_PEN_IDX;
...
ALTER INDEX API_MACROS.MACRO_EVENT_PK REBUILD TABLESPACE API_PEN_IDX;
ALTER INDEX API_MACROS.MACRO_EVENT_EVENT_STATUS_IDX REBUILD TABLESPACE API_PEN_IDX;
ALTER INDEX API_MACROS.MACRO_EVENT_EVENT_TYPE_IDX REBUILD TABLESPACE API_PEN_IDX;
...
ALTER INDEX API_MACROS.MACRO_SHEDLOCK_PK REBUILD TABLESPACE API_PEN_IDX;
...
ALTER INDEX API_MACROS.MACRO_PK REBUILD TABLESPACE API_PEN_IDX;
ALTER INDEX API_MACROS.MACRO_CODE_MACRO_TYPE_CODE_BUSINESS_USE_TYPE_CODE_UK REBUILD TABLESPACE API_PEN_IDX;
